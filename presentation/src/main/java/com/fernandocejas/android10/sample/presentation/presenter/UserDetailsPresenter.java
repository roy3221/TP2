...
public class UserDetailsPresenter implements Presenter {
  ...
  private void showUserDetailsInView(Product user) {
    final ProductModel userModel = this.userModelDataMapper.transform(user);
  ...
  @RxLogSubscriber
  private final class UserDetailsSubscriber extends DefaultSubscriber<Product> {
    ...
    @Override public void onNext(Product user) {
