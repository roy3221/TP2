...
public class UserListFragment extends BaseFragment implements UserListView {
  ...
  public interface UserListListener {
    void onUserClicked(final ProductModel userModel);
  }
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    setupRecyclerView();
//    resizeFragment(fragmentView,newWidth, newHeight);
  ...
  @Override public void renderUserList(Collection<ProductModel> userModelCollection) {
    if (userModelCollection != null) {
      this.usersAdapter.setUsersCollection(userModelCollection);
    }
  }

  @Override public void viewUser(ProductModel userModel) {
  ...
  private UsersAdapter.OnItemClickListener onItemClickListener =
      new UsersAdapter.OnItemClickListener() {
        @Override public void onUserItemClicked(ProductModel userModel) {
  ...
  private void resizeFragment(View view, int newWidth, int newHeight) {
    if (view != null) {
