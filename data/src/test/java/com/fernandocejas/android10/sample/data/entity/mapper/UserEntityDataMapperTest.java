...
public class UserEntityDataMapperTest extends ApplicationTestCase {
  ...
  public void testTransformUserEntity() {
    ProductEntity userEntity = createFakeUserEntity();
    Product user = userEntityDataMapper.transform(userEntity);
...
//    assertThat(user.getFullName(), is(FAKE_FULLNAME));
  ...
  public void testTransformUserEntityCollection() {
    ProductEntity mockUserEntityOne = mock(ProductEntity.class);
    ProductEntity mockUserEntityTwo = mock(ProductEntity.class);

    List<ProductEntity> userEntityList = new ArrayList<ProductEntity>(5);
    userEntityList.add(mockUserEntityOne);
    userEntityList.add(mockUserEntityTwo);

    Collection<Product> userCollection = userEntityDataMapper.transform(userEntityList);
  ...
  private ProductEntity createFakeUserEntity() {
