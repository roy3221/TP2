...
public class UserEntityDataMapper {
  ...
  public Product transform(ProductEntity productEntity) {
    ...
    if (productEntity != null) {
      ...
      product.setImage_height(productEntity.getImage_height());
      product.setImage_width(productEntity.getImage_width());
      product.setImage_url(productEntity.getImage_url());
    }
