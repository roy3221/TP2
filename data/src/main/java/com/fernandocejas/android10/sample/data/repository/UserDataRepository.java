...
public class UserDataRepository implements UserRepository {
  ...
  @Override public Observable<List<Product>> users() {
  ...
  @SuppressWarnings("Convert2MethodRef")
  @Override public Observable<Product> user(int id) {
    final UserDataStore userDataStore = this.userDataStoreFactory.create(id);
    return userDataStore.userEntityDetails(id)
