...
public class UserCacheImpl implements UserCache {
  ...
  @Override public Observable<ProductEntity> get(final int id) {
    return Observable.create(subscriber -> {
      File userEntityFile = UserCacheImpl.this.buildFile(id);
      String fileContent = UserCacheImpl.this.fileManager.readFileContent(userEntityFile);
      ProductEntity userEntity = UserCacheImpl.this.serializer.deserialize(fileContent);
  ...
  @Override public void put(ProductEntity userEntity) {
    if (userEntity != null) {
  ...
  @Override public boolean isCached(int id) {
    File userEntitiyFile = this.buildFile(id);
